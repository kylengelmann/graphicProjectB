...
var cube = new class {
  ...
  '  float nDotL = dot(-v_norm, lightDir);\n' +
  '  vec3 light = vec3(1.0, 1.0, 1.0)*nDotL;\n' +
  '  gl_FragColor = vec4(v_colr.rgb*(light*.6 + .4), 1.0); \n' +
  '}\n';

    var x = makeCube([1, 0, 0, 1]);
...
function makeCube(col) {
  var cubeVerts = new Float32Array([
    0, 0, 0, 1, 0, -1, 0, 0, col[0], col[1], col[2], col[3], 
    1, 0, 0, 1, 0, -1, 0, 0, col[0], col[1], col[2], col[3], 
    0, 0, 1, 1, 0, -1, 0, 0, col[0], col[1], col[2], col[3], 
    1, 0, 1, 1, 0, -1, 0, 0, col[0], col[1], col[2], col[3], 
 
    0, 0, 1, 1, 0, 0, 1,  0,col[0], col[1], col[2], col[3], 
    1, 0, 1, 1, 0, 0, 1,  0,col[0], col[1], col[2], col[3], 
    0, 1, 1, 1, 0, 0, 1,  0,col[0], col[1], col[2], col[3], 
    1, 1, 1, 1, 0, 0, 1,  0,col[0], col[1], col[2], col[3], 
 
    0, 1, 1, 1, 0, 1, 0,  0,col[0], col[1], col[2], col[3], 
    1, 1, 1, 1, 0, 1, 0,  0,col[0], col[1], col[2], col[3], 
    0, 1, 0, 1, 0, 1, 0,  0,col[0], col[1], col[2], col[3], 
    1, 1, 0, 1, 0, 1, 0,  0,col[0], col[1], col[2], col[3], 
 
    0, 1, 0, 1, 0, 0, -1, 0, col[0], col[1], col[2], col[3], 
    1, 1, 0, 1, 0, 0, -1, 0, col[0], col[1], col[2], col[3],
    0, 0, 0, 1, 0, 0, -1, 0, col[0], col[1], col[2], col[3], 
    1, 0, 0, 1, 0, 0, -1, 0, col[0], col[1], col[2], col[3],  
 
    0, 0, 0, 1, -1, 0, 0, 0, col[0], col[1], col[2], col[3],
    0, 1, 0, 1, -1, 0, 0, 0, col[0], col[1], col[2], col[3],
    0, 0, 1, 1, -1, 0, 0, 0, col[0], col[1], col[2], col[3], 
    0, 1, 1, 1, -1, 0, 0, 0, col[0], col[1], col[2], col[3], 

    1, 0, 0, 1, 1, 0, 0, 0, col[0], col[1], col[2], col[3], 
    1, 1, 0, 1, 1, 0, 0, 0, col[0], col[1], col[2], col[3],
    1, 0, 1, 1, 1, 0, 0, 0, col[0], col[1], col[2], col[3], 
    1, 1, 1, 1, 1, 0, 0, 0, col[0], col[1], col[2], col[3],
    ]);
